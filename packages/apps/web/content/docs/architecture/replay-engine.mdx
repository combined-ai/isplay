...
<Steps>
  ...
  <Step>If replay can continue, produce branch events and finish status.</Step>
  <Step>Compute trace, tool, state, metric, and effect output.</Step>
</Steps>
...
| Diffs | Trace, tool, state, output, metric, or causal comparisons. |
